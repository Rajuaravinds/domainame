...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Experienced in Splunk Support Tickets as Splunk Support Engineer (SSE).",
      "Integrating AWS Elastic Kubernetes Service into Splunk Enterprise using Lamada Function.",
      "Knowledge about Splunk architecture and various components (indexer, forwarder, search head, deployment server), Heavy and Universal forwarder, License mode",
      ...
      "Developed Splunk App with Splunk Dashboard Studio.",
      ...
      "efficient Splunk search Queries.",
    ],
  },
  {
